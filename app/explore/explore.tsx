...
const MOCK_SKILLS = [
  {
    ...
    skillDescription:
      "Experienced in building scalable web applications using React, Next.js, and Node.js. Passionate about clean code and accessible UI.",
  ...
  },
  {
    ...
    skillDescription:
      "Helping startups grow their organic traffic and build compelling product narratives. Proficient in Ahrefs, Google Analytics, and content strategy.",
  ...
  },
  {
    ...
    skillDescription:
      "Creating intuitive and visually stunning user experiences. Specializing in Figma prototyping, user research, and design systems.",
